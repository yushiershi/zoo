<template>
    <zoo-content title="收益记录">
	  ...
	  <div class="button-row">
	    <zoo-button label="出售" class="point-button" type="medium" width="72px"
	      @click="gotoPage('./cs?profit='+point)"></zoo-button>
	  </div>
	  <el-divider></el-divider>
      <div class="profit-content" v-infinite-scroll="load">
      ...
      load(){
        if(this.flag){
          ...
          getPointList({
            ...
            that.pagenum++;
            that.point = res.data.extras.recommondprofit;
